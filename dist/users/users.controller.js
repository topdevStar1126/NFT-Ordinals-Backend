...
let UsersController = class UsersController {
    ...
    async findOne(req, wallet) {
        ...
        const user = req.user;
        return this.usersService.findOne((_b = user === null || user === void 0 ? void 0 : user.address.toLowerCase()) !== null && _b !== void 0 ? _b : "", wallet.toLowerCase());
    }
